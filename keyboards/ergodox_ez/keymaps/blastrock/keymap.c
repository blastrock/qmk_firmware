...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT_ergodox(
      ...
      KC_UP,KC_DOWN,KC_RGUI,KC_RALT,KC_RCTRL,
  ...
  [MLAYER] = LAYOUT_ergodox(
      SWITCH_MY,KC_AUDIO_MUTE,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
      SWITCH_QWERTY,KC_AUDIO_VOL_UP,KC_TRANSPARENT,KC_MS_UP,KC_TRANSPARENT,KC_MS_WH_UP,KC_TRANSPARENT,
      KC_TRANSPARENT,KC_AUDIO_VOL_DOWN,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,KC_MS_WH_DOWN,
      KC_TRANSPARENT,KC_MEDIA_PREV_TRACK,KC_MEDIA_STOP,KC_MEDIA_PLAY_PAUSE,KC_TRANSPARENT,KC_MEDIA_NEXT_TRACK,KC_TRANSPARENT,
