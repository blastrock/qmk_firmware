...
#define FLATDOX_I2C_TIMEOUT 100

uint8_t init_mcp23018(void);

inline void flatdox_right_led_1(bool on) {
    writePin(D3, on);
}
inline void flatdox_right_led_2(bool on) {
    writePin(D2, on);
}
inline void flatdox_right_led_3(bool on) {
    writePin(B0, on);
}
