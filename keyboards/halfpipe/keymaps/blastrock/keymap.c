...
[MY] = LAYOUT_flat(
  ...
  KC_ESC,    MY_A,         MY_S,          MY_D,    MY_F,    MY_G,    KC_LBRC,             KC_RBRC,     MY_H,    MY_J,    MY_K,    MY_L,     MY_SCLN,        KC_QUOT,
  KC_LSFT,   LCTL_T(MY_Z), MY_X,          MY_C,    MY_V,    MY_B,                                      MY_N,    MY_M,    MY_COMM, MY_DOT,  RCTL_T(MY_SLSH), KC_RSFT,
  KC_LGUI,   KC_LALT,      KC_LEFT,       KC_RGHT,                                                                       KC_UP,   KC_DOWN,  KC_RALT,        KC_RGUI,
                                                    KC_SPC, KC_HOME, KC_END,              KC_PGUP, KC_PGDN, KC_ENT,
                                                            KC_BSPC, KC_LGUI,             KC_RGUI, KC_TAB
),
...
[SYMB] = LAYOUT_flat(
  ...
  EE_CLR,  KC_TRNS, KC_TRNS, KC_TRNS,                                                           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
[MDIA] = LAYOUT_flat(
  ...
  KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_TRNS, KC_TRNS,
  KC_TRNS, KC_MPRV, KC_TRNS, KC_MPLY, KC_TRNS, KC_MNXT,                       KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU,                                                           KC_P0,   KC_PDOT, KC_TRNS, KC_TRNS,
